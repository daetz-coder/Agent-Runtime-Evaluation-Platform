...
- `scripts/eval_evaluator_accuracy.py`
...
- 代码入口：scripts/eval_evaluator_accuracy.py
...
A: 打开 scripts/eval_evaluator_accuracy.py，再对照 app/graphs/evaluation_graph.py 的数据流。
